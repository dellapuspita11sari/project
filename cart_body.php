  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">TROLI</span> COCO
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > saat ini anda memiliki <?php echo $count; ?> barang dikeranjang anda. </p>
...
<input class="btn btn-primary" type="submit" name="apply_coupon" value="Terapkan Kode Kupon" >
...
echo "<script>alert('Kode Kupon Anda Telah Kadaluarsa')</script>";
...
echo "<script>alert('Kode Kupon Anda telah Diterapkan')</script>";
...
echo "<script>alert('Produk Tidak Ada Dikeranjang')</script>";
...
echo "<script> alert('Kode Kupon Anda Tidak Valid') </script>";
...
<h3 class="text-center"> Anda juga menyukai produk ini</h3>
...
<p class="text-muted">
Pengiriman dan biaya tambahan dihitung berdasarkan nilai yang telah anda masukan.
</p>
