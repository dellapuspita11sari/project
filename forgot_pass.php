  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Lupa</span> Sandi
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<h3> Masukkan Email anda dibawah ini , Kami akan mengirimkan , Kata Sandi Anda </h3>
...
<input type="text" class="form-control" name="c_email" placeholder="kirim Email">

<br>

<input type="submit" name="forgot_pass" class="btn btn-primary" value="Kirim Kata Sandi Saya">
