...
<i class="fa fa-dashboard"> </i> Dashboard / Sisipkan Bundle
...
<i class="fa fa-money fa-fw"></i> Sisipkan Bundle
...
<label class="col-md-3 control-label" > Judul paket </label>
...
<label class="col-md-3 control-label" > paket Url </label>
...
<label class="col-md-3 control-label" > Pilih Produsen </label>
...
<label class="col-md-3 control-label" > Bundle Gambar 1 </label>
...
<label class="col-md-3 control-label" > Bundle Gambar 2 </label>
...
<label class="col-md-3 control-label" > Bundle Gambar 3 </label>
...
<label class="col-md-3 control-label" > harga paket </label>
...
<label class="col-md-3 control-label" > harga obral paket </label>
...
<label class="col-md-3 control-label" > Bundle kata sandi </label>
...
<label class="col-md-3 control-label" > Tab paket  </label>
...
<a data-toggle="tab" href="#description"> diskripsi Paket </a>

</li>

<li>

<a data-toggle="tab" href="#features"> fitur paket </a>

</li>

<li>

<a data-toggle="tab" href="#video"> suara dan vidio </a>
