...
<i class="fa fa-dashboard" ></i> Dashboard / sisipkan jenis permintaan
...
<i class="fa fa-money fa-fw"></i> masukkan jenis permintaan 
...
<label class="col-md-3 control-label"> judul pertanyaan </label>
