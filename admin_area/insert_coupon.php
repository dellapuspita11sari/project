...
<i class="fa fa-dashboard"> </i> Dashboard / masukkan kupon
...
<i class="fa fa-money fa-fw"> </i> masukkan kupon
...
<label class="col-md-3 control-label"> judul kupon </label>
...
<label class="col-md-3 control-label"> harga kupon </label>
...
<label class="col-md-3 control-label"> kode kupon </label>
...
<label class="col-md-3 control-label"> batas kupon </label>
...
<label class="col-md-3 control-label">beli kupon untuk produk atau Bundle</label>

<div class="col-md-6">

<select name="product_id" class="form-control">

<option> beli produk kupon  </option>
...
<option>pilih kupon untuk Bundle</option>
