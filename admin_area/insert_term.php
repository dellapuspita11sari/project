...
<i class="fa fa-dashboard"></i> Dashboard / masukkan ketentuan
...
<i class="fa fa-money fa-fw"></i> masukkan ketentuan
...
<label class="col-md-3 control-label"> judul ketentuan </label>
...
<label class="col-md-3 control-label"> deskripsi ketentuan </label>
...
<label class="col-md-3 control-label"> Link ketentuan </label>
