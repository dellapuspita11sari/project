...
<i class="fa fa-dashboard" ></i> Dashboard / Edit Halaman Tentang Kami
...
<i class="fa fa-money fa-fw"></i> Edit Halaman Tentang Kami
...
<label class="col-md-3 control-label"> Tentang Kami Untuk  : </label>
...
<label class="col-md-3 control-label"> Tentang Kami Deskripsi Singkat : </label>
...
<label class="col-md-3 control-label"> Tentang Kami Keterangan : </label>
