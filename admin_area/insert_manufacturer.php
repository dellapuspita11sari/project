...
<i class="fa fa-dashboard"></i> Dashboard / sisipkan produsen 
...
<i class="fa fa-money fa-fw"> </i> sisipkan produsen
...
<label class="col-md-3 control-label"> nama produsen </label>
...
<label class="col-md-3 control-label"> tampilkan sebagai pabrikan teratas </label>
...
<label class="col-md-3 control-label"> pilih gambar produsen </label>
