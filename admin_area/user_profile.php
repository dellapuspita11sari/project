...
<i class="fa fa-dashboard" ></i> Dashboard / Edit Profil
...
<i class="fa fa-money fa-fw" ></i> Edit Profil
...
<label class="col-md-3 control-label">kata sandi pengguna: </label>
...
<label class="col-md-3 control-label">negara pengguna: </label>
...
<label class="col-md-3 control-label">pekerjaan pengguna: </label>
...
<label class="col-md-3 control-label">kontak pengguna: </label>
...
<label class="col-md-3 control-label">tentang pengguna: </label>
