...
<i class="fa fa-dashboard"> </i> Dashboard / masukkan produk
...
<label class="col-md-3 control-label" > produk Url </label>
...
contoh Url produk : kelapa serut
...
<label class="col-md-3 control-label" > produk kategori  </label>

<div class="col-md-6" >

<select name="product_cat" class="form-control" >

<option> pilih produk produsen </option>
...
<label class="col-md-3 control-label" > harga jual produk </label>
...
<label class="col-md-3 control-label" > katasandi produk </label>
...
<label class="col-md-3 control-label" > tab produk </label>
...
<a data-toggle="tab" href="#description"> deskripsi produk </a>

</li>

<li>

<a data-toggle="tab" href="#features"> fitur produk </a>
...
<label class="col-md-3 control-label" > Label produk </label>
