...
<i class="fa fa-dashboard" ></i> Dashboard / Edit Hubungi Kami
...
<i class="fa fa-money fa-fw"></i> Edit Hubungi Kami  
...
<label class="col-md-3 control-label"> Email Kontak : </label>
...
<label class="col-md-3 control-label"> Judul Kontak: </label>
...
<label class="col-md-3 control-label"> Deskripsi Kontak: </label>
