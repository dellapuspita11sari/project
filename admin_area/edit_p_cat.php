...
<i class="fa fa-dashboard"></i> Dashboard / Edit Kategori Produk
...
<i class="fa fa-money fa-fw" ></i> Edit Kategori Produk
...
<label class="col-md-3 control-label" >Tampilkan Sebagai Kategori Teratas</label>
...
<label class="col-md-3 control-label" > Pilih Gambar Kategori Produk</label>
