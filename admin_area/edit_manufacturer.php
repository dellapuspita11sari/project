...
<i class="fa fa-dashboard"></i> Dashboard / Edit Produsen
...
<i class="fa fa-money fa-fw"> </i> Edit Produsen
...
<label class="col-md-3 control-label"> Pilih Produsen Gambar </label>
