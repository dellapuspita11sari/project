...
<i class="fa fa-dashboard"></i> Dashboard / sisipkan kategori
...
<i class="fa fa-money fa-fw"></i> sisipkan kategori
...
<label class="col-md-3 control-label">pilih gambar kategori</label>
