...
<i class="fa fa-dashboard" ></i> Dashboard / Edit Toko
...
<i class="fa fa-money fa-fw"></i> Edit Toko
...
<label class="col-md-3 control-label"> Judul Toko : </label>
...
<label class="col-md-3 control-label"> Menyimpan URL : </label>
