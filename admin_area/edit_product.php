...
$manufacturer_id = isset($row_manfacturer['manufacturer_id']);

$manufacturer_title = isset($row_manfacturer['manufacturer_title']);
...
<i class="fa fa-dashboard"> </i> Dashboard / Edit Produk
...
<i class="fa fa-money fa-fw"></i> Edit Produk
...
<label class="col-md-3 control-label" > Url Produk </label>
...
Contoh Url Produk: Batok Kelapa
