...
<i class="fa fa-dashboard" ></i> Dashboard / Edit Jenis Permintaan
...
<i class="fa fa-money fa-fw"></i> Edit Jenis Permintaan 
...
<label class="col-md-3 control-label"> Judul Permintaan </label>
