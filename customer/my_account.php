  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Akun </span>Saya
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<strong> Peringatan! </strong> Harap Konfirmasikan Email Anda dan Jika Anda Belum Menerima Email Konfirmasi Anda
...
echo "<script>alert('email anda telah dikonfirmasi')</script>";
...
<a href='localhost/ecom_store/customer/my_account.php?$customer_confirm_code'>klik disini untuk mengkonfirmasi email</a>";
...
echo "<script>alert('email konfirmasi anda telah terkirim, periksa kontak masuk anda')</script>";
