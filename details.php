...
$p_cat_title = isset($row_p_cat['p_cat_title']);
  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Tampilan </span>Produk
      </div>
      <p class="nero__text">
      </p>
    </div>
...
echo "<script>alert('Produk ini Sudah Ditambahkan ke Keranjang')</script>";
...
<label class="col-md-5 control-label" >tingkat kematengan</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<!-- <select name="product_size" class="form-control" >

<option>tingakat</option>
...
Harga Produk : <del> Rp.$pro_price </del><br>
...
if($pro_label == "Jual" or $pro_label == "Gift"){
...
<i class="fa fa-shopping-cart" ></i> Tambahkan ke troli

</button>

<button class="btn btn-warning" type="submit" name="add_wishlist">

<i class="fa fa-heart" ></i> Tambahkan ke daftar keinginan
...
echo "<script>alert('Anda Harus Masuk Untuk Menambahkan Produk di Daftar Keinginan ')</script>";
...
echo "<script>alert('Produk Ini Telah Ditambahkan Di Daftar Keinginan')</script>";
...
echo "<script> alert('Produk Telah Di Masukkan Wishlist') </script>";
...
<h3 class="text-center"> Anda mungkin juga menyukai Produk ini: Kami memberi anda 3 item produk. </h3>
...
$manufacturer_name = isset($row_manufacturer['manufacturer_title']);
...
<h3 class="text-center"> Produk Bundel</h3>
