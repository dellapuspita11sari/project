  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Daftar</span> coco 
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<label> Kata Sandi Pelanggan </label>
...
<input type="Kata Sandi" class="form-control confirm" id="con_pass" required>
...
<button type="Kirimkan" name="register" class="btn btn-primary">
...
if(val.length<=6)no=1;
 ...
 // If the password length is greater than 6 and contain any lowercase alphabet or any number or any special character
  ...
  if(no==3)
  {
   ...
   document.getElementById("pass_type").innerHTML="Bagus";
  }
...
<h2>
Konfirmasi Email oleh Computerfever.com $c_name
</h2>
...
echo "<script>alert('Anda Telah Berhasil diDaftarkan ')</script>";
...
echo "<script>alert('Silahkan Pilih Captcha, Coba Lagi')</script>";
